...
int imgId = 0;
string dataDir = "/home/yuan/XSpace/Ending/Camera/AstraSDK-v2.0.16-Linux/data/";
void saveImage(RenderWindow &window)
{
    stringstream ss;
    ss<<dataDir<<setw(5)<<setfill('0')<<imgId++<<".png";
    sf::String const& path = ss.str();
            ...
            case sf::Event::KeyPressed:
                {
                    ...
                    case sf::Keyboard::F:
                        ...
                        break;
//                     case sf::Keyboard::V:
//                         window.create(sf::VideoMode(1221, 665), "Video", 
