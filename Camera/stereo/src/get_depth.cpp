...
void stereo_match_sgbm(int, void*)                                         //SGBM匹配算法
{
    ...
    cout<<"xyz: "<<xyz.cols<<'\t'<<xyz.rows<<'\t'<<xyz.channels()<<endl;
...
int main()
{
	...
	viewLeft = imread("/home/yuan/XSpace/Ending/Camera/stereo/dataset/00000_left.png", 1);//cameraIdLef  参数为相机采集的图像路径
	viewRight = imread("/home/yuan/XSpace/Ending/Camera/stereo/dataset/00000_right.png", 1); //cameraIRight
