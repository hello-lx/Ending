...
if __name__ == '__main__':
    ...
    path_name = "/home/yuan/XSpace/Dataset/sequences/00"
    image_index = 0
    rate = rospy.Rate(5)
    ...
    while True:
        ...
        # show all image
        h, w = left_img.shape
        cv2.imshow("left", cv2.resize(left_img, (w//2, h//2)))
        cv2.imshow("right", cv2.resize(right_img, (w//2, h//2)))
        cv2.imshow("depth", cv2.resize(col, (w//2, h//2)))
